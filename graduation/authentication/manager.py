...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, first_name, last_name, password, edu_id, **extra_fields):
        ...
        user=self.create_user(email, first_name, last_name, password, edu_id, **extra_fields)
